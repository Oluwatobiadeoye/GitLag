package com.intermediate.android.gitlagos;
...
/**
 * Created by adeoye oluwatobi on 9/12/2017.
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent userProfile = new Intent(v.getContext(),Userprofile_Activity.class);
